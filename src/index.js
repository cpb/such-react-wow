...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.DogePile = exports.HelloDoge = undefined;
	...
	var HelloDoge = exports.HelloDoge = function (_React$Component) {
	  _inherits(HelloDoge, _React$Component);

	  function HelloDoge() {
	    _classCallCheck(this, HelloDoge);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(HelloDoge).apply(this, arguments));
	  }

	  _createClass(HelloDoge, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        'h1',
	        null,
	        'Such world! Wow. Much hello ',
	...
	var DogePile = exports.DogePile = function DogePile(id, items) {
	  _reactDom2.default.render(_react2.default.createElement(HelloDoge, { items: items }), document.getElementById(id));
	};
